...
export default function LoginPage() {
  ...
  // Redirect if already authenticated (handles Google redirect flow)
  useEffect(() => {
    if (user) navigate('/')
  }, [user, navigate])
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      if (result) navigate('/') // DEV: popup returns result immediately
      // PROD: signInWithRedirect navigates away, never reaches here
    } catch (err) {
